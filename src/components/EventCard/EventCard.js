...
function EventCard(props) {
	...
	return (
		<div className="eventCard" onClick={openEventPage} style={{ backgroundImage: `url${imageUrl}` }}>
			<div className="eventCard__contactInformationBox">
				<p className="eventCard__contactInformationBox__address">Место проведения: {address}</p>
